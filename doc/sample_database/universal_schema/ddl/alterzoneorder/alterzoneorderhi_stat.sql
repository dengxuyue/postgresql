...
COLLECT STATISTICS ON ST_HIX INDEX(ASSOCIATE_PARTY_ID);

COLLECT STATISTICS ON SALES_TRANSACTION COLUMN(TRAN_DATE);

COLLECT STATISTICS ON STL_HIX INDEX(LOCATION, ITEM_ID);

COLLECT STATISTICS ON SALES_TRANSACTION_LINE COLUMN(TRAN_LINE_DATE);

COLLECT STATISTICS ON RTL_HIX INDEX(LOCATION_ID, RETURNED_ITEM_ID);
