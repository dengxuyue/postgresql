...
/*Specific Statistics*/COLLECT STATISTICS ON STL_I_MLJIX INDEX(JIXC1);

COLLECT STATISTICS ON STL_I_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON STL_SJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON STL_SJIX COLUMN(JIXC3);

COLLECT STATISTICS ON RTL_I_MLJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON RTL_I_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON RTL_SJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON RTL_SJIX COLUMN(JIXC3);

COLLECT STATISTICS ON STL_ST_P_MLJIX INDEX(JIXC1);

COLLECT STATISTICS ON STL_ST_P_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON STL_ST_MLJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON STL_ST_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON RTL_ST_P_MLJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON RTL_ST_P_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON RTL_ST_MLJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON RTL_ST_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON ST_P_MLJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON ST_P_MLJIX COLUMN(JIXC3);

COLLECT STATISTICS ON P_D_MLJIX INDEX(JIXC1);

COLLECT STATISTICS ON IPH_SJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON IPH_SJIX COLUMN(JIXC3);
