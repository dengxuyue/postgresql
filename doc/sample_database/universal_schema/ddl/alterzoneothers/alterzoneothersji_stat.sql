...
/*Specific Statistics*/COLLECT STATISTICS ON L_D_R_DIV_AD_MLJIX INDEX(JIXC5);

COLLECT STATISTICS ON IIP_SJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON IIP_SJIX COLUMN(JIXC3);

COLLECT STATISTICS ON ABE_SJIX INDEX(JIXC1, JIXC3);

COLLECT STATISTICS ON ABE_SJIX COLUMN(JIXC3);

COLLECT STATISTICS ON ALE_SJIX INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON ALE_SJIX COLUMN(JIXC3);
