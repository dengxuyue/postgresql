...
COLLECT STATISTICS ON LOCATION_PLAN COLUMN(PERIOD_START_DT, LOCATION_ID);

COLLECT STATISTICS ON LABOR_PLAN COLUMN(PARTITION);

COLLECT STATISTICS ON LABOR_PLAN COLUMN(PLAN_PERIOD_START_DT, LOCATION_ID);

COLLECT STATISTICS ON ITEM_INVENTORY_PLAN COLUMN(PARTITION);

COLLECT STATISTICS ON ITEM_INVENTORY_PLAN COLUMN(LOCATION_ID, ITEM_INVENTORY_PLAN_DT);

COLLECT STATISTICS ON ITEM_INVENTORY COLUMN(PARTITION);

COLLECT STATISTICS ON ITEM_INVENTORY COLUMN(LOCATION_ID, ITEM_INV_DT);

COLLECT STATISTICS ON ASSOCIATE_BENEFIT_EXPENSE COLUMN(PARTITION);

COLLECT STATISTICS ON ASSOCIATE_BENEFIT_EXPENSE COLUMN(ASSOCIATE_EXPNS_TYPE_CD, PERIOD_END_DT);

COLLECT STATISTICS ON ASSOCIATE_LABOR_EXPENSE COLUMN(PARTITION);

COLLECT STATISTICS ON ASSOCIATE_LABOR_EXPENSE COLUMN(ASSOCIATE_EXPNS_TYPE_CD, PERIOD_END_DT);
