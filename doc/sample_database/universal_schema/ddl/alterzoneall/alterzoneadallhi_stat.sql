...
/*Specific Statistics*/
COLLECT STATISTICS ON as_hi_1 INDEX(LOCATION_ID, ASSOCIATE_PARTY_ID);

COLLECT STATISTICS ON ASSOCIATE COLUMN(ASSOC_HIRE_DT);

COLLECT STATISTICS ON ale_hi_1 INDEX(ASSOCIATE_PARTY_ID);

COLLECT STATISTICS ON ASSOCIATE_LABOR_EXPENSE COLUMN(PERIOD_END_DT);

COLLECT STATISTICS ON abe_hi_1 INDEX(ASSOCIATE_PARTY_ID);

COLLECT STATISTICS ON ASSOCIATE_BENEFIT_EXPENSE COLUMN(PERIOD_END_DT);

COLLECT STATISTICS ON iti_hi_1 INDEX(LOCATION_ID);

COLLECT STATISTICS ON ITEM_INVENTORY COLUMN(ITEM_INV_DT);

COLLECT STATISTICS ON iip_hi_1 INDEX(LOCATION_ID);

COLLECT STATISTICS ON iip_hi_1 COLUMN(ITEM_INVENTORY_PLAN_DT);

COLLECT STATISTICS ON iph_hi_1 INDEX(ITEM_ID);

COLLECT STATISTICS ON iph_hi_1 COLUMN(ITEM_PRICE_START_DT);

COLLECT STATISTICS ON loc_hi_1 INDEX(LOCATION_ID);

COLLECT STATISTICS ON sat_hi_1 INDEX(ASSOCIATE_PARTY_ID);

COLLECT STATISTICS ON SALES_TRANSACTION COLUMN(TRAN_DATE);

COLLECT STATISTICS ON stl_hi_1 INDEX(LOCATION, ITEM_ID);

COLLECT STATISTICS ON SALES_TRANSACTION_LINE COLUMN(TRAN_LINE_DATE);

COLLECT STATISTICS ON rtl_hi_1 INDEX(LOCATION_ID, RETURNED_ITEM_ID);
