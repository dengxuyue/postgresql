...
/*Specific Statistics*/
COLLECT STATISTICS ON usji01 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji01 COLUMN(JIXC5);

COLLECT STATISTICS ON usji02 INDEX(JIXC1);

COLLECT STATISTICS ON usji02 COLUMN(JIXC3);

COLLECT STATISTICS ON usji03 INDEX(JIXC1);

COLLECT STATISTICS ON usji03 COLUMN(JIXC3);

COLLECT STATISTICS ON usji04 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji04 COLUMN(JIXC3);

COLLECT STATISTICS ON usji05 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji05 COLUMN(JIXC5);

COLLECT STATISTICS ON usji06 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji06 COLUMN(JIXC3);

COLLECT STATISTICS ON usji07 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji07 COLUMN(JIXC3);

COLLECT STATISTICS ON usji08 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji08 COLUMN(JIXC3);

COLLECT STATISTICS ON usji09 INDEX(JIXC1);

COLLECT STATISTICS ON usji09 COLUMN(JIXC3);

COLLECT STATISTICS ON usji10 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji10 COLUMN(JIXC3);

COLLECT STATISTICS ON usji11 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji11 COLUMN(JIXC3);

COLLECT STATISTICS ON usji12 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji12 COLUMN(JIXC3);

COLLECT STATISTICS ON usji13 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji13 COLUMN(JIXC3);

COLLECT STATISTICS ON usji15 INDEX(JIXC1, JIXC3);

COLLECT STATISTICS ON usji15 COLUMN(JIXC4);

COLLECT STATISTICS ON usji16 INDEX(JIXC1);

COLLECT STATISTICS ON usji17 INDEX(JIXC5);

COLLECT STATISTICS ON usji19 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji19 COLUMN(JIXC3);

COLLECT STATISTICS ON usji18 INDEX(JIXC1, JIXC3);

COLLECT STATISTICS ON usji18 COLUMN(JIXC5);

COLLECT STATISTICS ON usji20 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji20 COLUMN(JIXC3);

COLLECT STATISTICS ON usji21 INDEX(JIXC1, JIXC3);

COLLECT STATISTICS ON usji21 COLUMN(JIXC3);

COLLECT STATISTICS ON usji22 INDEX(JIXC1, JIXC2);

COLLECT STATISTICS ON usji22 COLUMN(JIXC3);
