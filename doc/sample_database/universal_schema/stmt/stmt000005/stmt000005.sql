select
    ...
    sum(n3.item_qty) as just_sold,
    n2.balance - sum(n3.item_qty) as whats_left
...
(
    ...
    from (
        select 
            ...
            iip.Plan_On_Hand_Qty - sum(stl.item_qty) as balance
